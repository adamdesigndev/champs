...
<template>
  <div>
    ...
    <!-- Two-column section highlighting team information -->
    <BasicTwoColumn
    ...
    <!-- Two-column section on animal welfare commitment -->
    <BasicTwoColumn
...
// First two-column section (Our Team)
const firstTwoColumnImageSrc = "/images/Champs-worker.jpg";
const firstTwoColumnImageAlt = "";
const firstTwoColumnHeader = "Our Team";
const firstTwoColumnBody = "We are committed to prioritizing safety in all our offices and Company-owned restaurants around the world, as well as supporting our Franchisees to do the same in the restaurants they own and operate. We are also continuing to foster respectful workplaces where people can be themselves without fear of harassment, discrimination, retaliation, or violence.";
const firstTwoColumnButtonText = "Learn More";
const firstTwoColumnButtonLink = "/About";

// Second two-column section (Animal Welfare)
