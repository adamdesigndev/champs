...
export const foodItems = [
  // Drinks
    ...
    },
    {
      ...
      description: 'Classic lemonade with a sweet, refreshing taste.',
      sizes: {
        small: 0.99,
        medium: 1.09,
        large: 1.19
    ...
    {
      name: 'Dr Pepper®',
      description: 'Cool off with a refreshing Dr Pepper®.',
      sizes: {
        small: 0.99,
        medium: 1.09,
        large: 1.19
    ...
    {
      name: 'Fanta® ',
      description: 'Tingly, fruity taste that is bright and bubbly.',
      sizes: {
        small: 0.99,
        medium: 1.09,
        large: 1.19
    ...
    {
      name: 'Oreo® Shake',
      description: 'Classic OREO® cookies pieces make this thick and creamy shake one of the best ways to have your milk and cookies.',
      sizes: {
        small: 3.99,
        medium: 4.99,
        large: 5.99
    ...
    },
    {
      ...
      description: 'Our thick and creamy shake with chocolate syrup is a timeless classic. Get it before it is gone. Just kidding, it is not going anywhere.',
      sizes: {
        small: 3.99,
        medium: 4.99,
        large: 5.99
    ...
    {
      name: 'Vanilla Shake',
      description: 'A thick and creamy vanilla shake. It is old-school cool.',
      sizes: {
        small: 3.99,
        medium: 4.99,
        large: 5.99
    ...
    {
      name: 'FRENCH FRIES',
      description: 'Potatoe fries cooked in canola oil until crispy outside and tender inside. Sprinkled with Sea Salt.',
      sizes: {
        small: 1.99,
        medium: 2.99,
        large: 3.99
    ...
    {
      name: 'CURLY FRIES',
      description: 'Perfectly seasoned, crispy curly fries..',
      sizes: {
        small: 1.99,
        medium: 2.99,
        large: 3.99
